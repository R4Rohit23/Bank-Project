    ...
    if (($amount)<0)
   {
    ...
    //For 0 (zero) value
         ...
         echo "</script>";
                ...
                $sql = "UPDATE customer set current_bal=$newbalance where id=$from";
                mysqli_query($conn,$sql);
             
                $newbalance = $sql2['current_bal'] + $amount;
                $sql = "UPDATE customer set current_bal=$newbalance where id=$to";
                mysqli_query($conn,$sql);
...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">SPARKS BANK <img src="img/bank.png" alt="Bank" width="50" height="50"></a>
                ...
                <ul class="navbar-nav me-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item dropdown py-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item py-3" href="transfer.php">Money Transfer</a></li>
    ...
    <class class="welcome">
        <h2>
            <img src="img/m1.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> <img src="img/m2.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
        ...
        <div>
            <table class="table table-striped table-hover">
                ...
                <tr style="color : black;">
                    ...
                    <td class="py-2"><?php echo $rows['current_bal'] ?></td>
                </tr>
            </table>
        </div>
